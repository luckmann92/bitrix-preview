...
class PHPExcel_Worksheet_AutoFilter
{
    ...
    public function setRange($pRange = '')
    {
        ...
        $cellAddress = explode('!', mb_orig_strtoupper($pRange));
    ...
    {
        $fromColumn = mb_orig_strtoupper($fromColumn);
        $toColumn = mb_orig_strtoupper($toColumn);
    ...
    private static function filterTestInDateGroupSet($cellValue, $dataSet)
    {
        ...
        if (is_numeric($cellValue)) {
            ...
            foreach ($dateSet as $dateValue) {
                ...
                if (mb_orig_substr($dtVal, 0, mb_orig_strlen($dateValue)) == $dateValue) {
                    return true;
                }
            }
        }

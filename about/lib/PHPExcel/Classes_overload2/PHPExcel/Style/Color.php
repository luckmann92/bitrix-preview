...
class PHPExcel_Style_Color extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    public function getRGB()
    {
        ...
        return mb_orig_substr($this->argb, 2);
    }
    ...
    {
        $colour = mb_orig_substr($RGB, $offset, 2);
        if (!$hex) {
    ...
    {
        return self::getColourComponent($RGB, mb_orig_strlen($RGB) - 6, $hex);
    }
    ...
    {
        return self::getColourComponent($RGB, mb_orig_strlen($RGB) - 4, $hex);
    }
    ...
    {
        return self::getColourComponent($RGB, mb_orig_strlen($RGB) - 2, $hex);
    }

...
class PHPExcel_Calculation_TextData
{
    ...
    public static function ASCIICODE($characters)
    {
        ...
        if ((function_exists('mb_strlen')) && (function_exists('mb_substr'))) {
            ...
            if (mb_orig_strlen($characters) > 0) {
                $character = mb_orig_substr($characters, 0, 1);
            }
        ...
        if (!is_bool($needle)) {
            ...
            if (($offset > 0) && (PHPExcel_Shared_String::CountCharacters($haystack) > $offset)) {
                ...
                if (function_exists('mb_strpos')) {
                    ...
                    $pos = mb_orig_strpos($haystack, $needle, --$offset);
                }
                if ($pos !== false) {
                    return ++$pos;
                }
        ...
        if (!is_bool($needle)) {
            ...
            if (($offset > 0) && (PHPExcel_Shared_String::CountCharacters($haystack) > $offset)) {
                ...
                if (function_exists('mb_stripos')) {
                    ...
                    $pos = mb_orig_stripos($haystack, $needle, --$offset);
                }
                if ($pos !== false) {
                    return ++$pos;
                }
    ...
    public static function LEFT($value = '', $chars = 1)
    {
        ...
        if (function_exists('mb_substr')) {
            ...
            return mb_orig_substr($value, 0, $chars);
        }
    }
    ...
    public static function MID($value = '', $start = 1, $chars = null)
    {
        ...
        if (function_exists('mb_substr')) {
            ...
            return mb_orig_substr($value, --$start, $chars);
        }
    }
    ...
    public static function RIGHT($value = '', $chars = 1)
    {
        ...
        if ((function_exists('mb_substr')) && (function_exists('mb_strlen'))) {
            ...
            return mb_orig_substr($value, mb_orig_strlen($value) - $chars);
        }
    }
        ...
        if ($instance == 0) {
            ...
            while ($instance > 0) {
                if (function_exists('mb_strpos')) {
                    ...
                    $pos = mb_orig_strpos($text, $fromText, $pos+1);
                }
                if ($pos === false) {
                    break;
                }
            ...
            if ($pos !== false) {
                if (function_exists('mb_strlen')) {
                    ...
                    return self::REPLACE($text, ++$pos, mb_orig_strlen($fromText), $toText);
                }
            }
        }

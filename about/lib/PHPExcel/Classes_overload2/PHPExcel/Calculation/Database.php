...
class PHPExcel_Calculation_Database
{
    ...
    {
        $field = mb_orig_strtoupper(PHPExcel_Calculation_Functions::flattenSingleValue($field));
        ...
        foreach ($database as $dataRow => $dataValues) {
            ...
            foreach ($criteriaNames as $key => $criteriaName) {
                ...
                if (isset($dataValues[$k])) {
                    ...
                    $dataValue = (is_string($dataValue)) ? PHPExcel_Calculation::wrapResult(mb_orig_strtoupper($dataValue)) : $dataValue;

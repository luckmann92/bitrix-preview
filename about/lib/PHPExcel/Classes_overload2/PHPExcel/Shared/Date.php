...
class PHPExcel_Shared_Date
{
    ...
    public static function FormattedPHPToExcel($year, $month, $day, $hours = 0, $minutes = 0, $seconds = 0)
    {
        ...
        $century = mb_orig_substr($year, 0, 2);
        $decade = mb_orig_substr($year, 2, 2);
    ...
    {
        if (mb_orig_strtolower($pFormatCode) === mb_orig_strtolower(PHPExcel_Style_NumberFormat::FORMAT_GENERAL)) {
        ...
        if ((mb_orig_substr($pFormatCode, 0, 1) == '_') || (mb_orig_substr($pFormatCode, 0, 2) == '0 ')) {
            return false;
        }
        ...
        if (preg_match('/(^|\])[^\[]*['.self::$possibleDateFormatCharacters.']/i', $pFormatCode)) {
            ...
            if (mb_orig_strpos($pFormatCode, '"') !== false) {
                $segMatcher = false;
    ...
    public static function stringToExcel($dateValue = '')
    {
        ...
        if (mb_orig_strpos($dateValue, ':') !== false) {

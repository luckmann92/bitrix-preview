...
class PHPExcel_Shared_OLE_ChainedBlockStream
{
    ...
    public function stream_open($path, $mode, $options, &$openedPath)
    {
        ...
        parse_str(mb_orig_substr($path, 25), $this->params);
        ...
        if (isset($this->params['size'])) {
            $this->data = mb_orig_substr($this->data, 0, $this->params['size']);
        }
    ...
    public function stream_read($count)
    {
        ...
        $s = mb_orig_substr($this->data, $this->pos, $count);
        $this->pos += $count;
        return $s;
    }
    ...
    {
        return $this->pos >= mb_orig_strlen($this->data);
    }
    ...
    public function stream_seek($offset, $whence)
    {
        if ($whence == SEEK_SET && $offset >= 0) {
            ...
            $this->pos = mb_orig_strlen($this->data) + $offset;
        } else {
            return false;
        }
        return true;

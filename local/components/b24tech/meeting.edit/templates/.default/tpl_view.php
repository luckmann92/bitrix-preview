...
<div class="sidebar-block">
	...
	<div class="sidebar-block-inner">
        <a href="/timeman/meeting/" class="webform-small-button webform-small-button-blue" style="margin-bottom: 15px;width: 100%;text-align: center;">
            <span class="webform-small-button-text"><?=getMessage("ME_CU_DOWNLOAD_ALL")?></span>
        </a>
		...
		<table cellspacing="0" class="meeting-detail-info-layout">
            ...
            <tr>
                ...
                <td class="meeting-detail-right-column" id="meeting_state_text"><?=GetMessage('ME_CU_INTERNAL_' . ($arResult['PLACE'] ? '0' : '1'))?></td>
<!--                <td class="meeting-detail-right-column" id="meeting_state_text">--><?//=GetMessage('ME_CU_INTERNAL_' . ($arResult['MEETING']['PLACE'] ? '0' : '1')) ?><!--</td>-->
            </tr>
<?
if ($arResult['PLACE']):
...
?>
				<tr>
					...
					<td class="meeting-detail-right-column" id="meeting_state_text"><?=GetMessage('ME_CU_COLLEGIATE_'.$arResult['MEETING']['COLLEGIATE'])?></td>
				</tr>
				<tr>

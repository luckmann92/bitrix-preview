...
<div id="disk-attach-block-<?=$arResult['UID']?>" class="feed-com-files diskuf-files-entity"><?
	...
	{
		?>
		<?if($arParams['TYPE'] == 'meeting'):?>
			<div class="disk-uf-file-download-archive">
				<a href="/bitrix/services/main/ajax.php?action=disk.api.folder.downloadArchive&folderId=<?=$arParams['FOLDER_ID'];?>" class="disk-uf-file-download-archive-text"><?=GetMessage('WDUF_FILE_DOWNLOAD_ARCHIVE')?></a>
			</div>
		<?else:?>
			<div class="disk-uf-file-download-archive">

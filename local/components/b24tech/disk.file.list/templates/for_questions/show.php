...
<?if(!empty($arResult['FILES']) || !empty($arResult['IMAGES']) ):?>
	<div class="file-list-wrap">
<a class="meeting-agenda-bot-link meeting-dash-link file-show-link" href="javascript:void(0)" onclick="showFileList('disk-attach-block-<?=$arResult['UID']?>')">Материалы</a>
<div id="disk-attach-block-<?=$arResult['UID']?>" class="feed-com-files diskuf-files-entity js-is-hiden" ><?
...
<script type="text/javascript">
	...
	initViewer('disk-attach-block-<?=$arResult['UID']?>');

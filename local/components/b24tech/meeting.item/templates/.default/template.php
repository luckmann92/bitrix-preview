...
?>
				<tr class="meeting-ques-info-top meeting-ques-info-top-last">
					...
					<td class="meeting-ques-right"><div class="crm-list-stage-bar" id="CRM_LEAD_LIST_V12_PROGRESS_BAR_LEAD_4">
...
<div class="meeting-question-tasks-wrap">
	<div class="meeting-question-tasks-top">
		...
		<span class="meeting-link" onclick="AddQuickPopupTask(event, {'TITLE': '<?=$arResult['ITEM']['TITLE']?>'})"><?=GetMessage('MI_TASK_ADD')?></span><span class="meeting-link" onclick="showTaskSelector(this)"><?=GetMessage('MI_TASK_ATTACH')?></span>
	</div>
</div>

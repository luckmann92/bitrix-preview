...
<br/>
<div id="js-voting">
	<a class="webform-small-button webform-small-button-accept js-agreement-voting" href="javascript:void(0)" >
		<span class="webform-small-button-left"></span>
		<span class="webform-small-button-text">Ознакомлен</span>
